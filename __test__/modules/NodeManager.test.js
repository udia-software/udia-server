  ...
  describe("Mutation", () => {
    ...
    it("should error on creating top level Comment nodes", async done => {
      ...
      await expect(
        ...
        relationType: ["Cannot create top level COMMENT nodes."]
      });
      done();
    });
    ...
    it("should error on created child level Post nodes", async done => {
      ...
      await expect(
        ...
        relationType: ["Cannot create nested POST nodes."]
      });
      done();
    });
    ...
    it("should error on creating node with too long content", async done => {
      ...
      await expect(
        ...
        content: ["Content cannot be longer than 40000 characters."]
      });
      done();
    });
    ...
    it("should error on creating node with invalid url", async done => {
      ...
      await expect(
        ...
        content: ["Content must be a valid url."]
      });
      done();
    });
    ...
    it("should error on creating node with invalid parent", async done => {
      ...
      ).rejects.toHaveProperty("state", { parentId: ["Parent must exist."] });
      await expect(
        nodeManager.createNode(
          createdBy,
          "TEXT",
        ...
        parentId: ["ParentId must be a valid Mongo ObjectID."]
      });
      done();
    });
